...
import { ArrowLeft, FileText, Check, Sparkles, Download } from 'lucide-react';
import { motion, AnimatePresence } from 'motion/react';
import { NeuralBackground } from './neural-background';

interface GenerateDocumentProps {
  onBack?: () => void;
  onGenerate?: (doc: { prompt: string; format: string; selectedSnaps: string[] }) => void;
}
...
export function GenerateDocument({ onBack, onGenerate }: GenerateDocumentProps) {
