...
import { LayoutDashboard, Brain, Activity, Calendar, ChevronLeft, ChevronRight, Plus } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 py-6 flex flex-col gap-2 px-3">
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-3 px-3 py-3 rounded-xl transition-all relative group overflow-hidden ${
       ...
       <button
        onClick={onToggle}
        className="absolute -right-3 top-20 w-6 h-6 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center text-zinc-400 hover:text-white transition-colors z-50"
      >
